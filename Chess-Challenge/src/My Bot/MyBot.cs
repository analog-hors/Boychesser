...
public class MyBot : IChessBot {
    ...
    // bitshift is implicitly modulo 64, also used in pst part of eval function
            ...
            while (pieces != 0) {
                ...
                sqIndex =
                    ...
                    EvalWeight(112 + pieceType)
                        ...
                        // interleave another packed weight in that space
                        + (int)(
                        ...
                        // with the virtual pawn type we get 16 bytes of unused space in a row,
                        // which exactly fits the 4 relevant mobility weights
